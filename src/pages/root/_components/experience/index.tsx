...
const Experience = () => {
  return (
    <section
      className={cn(
        "min-h-dvh flex-center flex-col gap-y-2 lg:gap-y-6 border-b pt-14 pb-6 px-2 lg:px-0",
    ...
    >
      ...
      <p className="text-xs lg:text-sm text-muted-foreground text-center lg:mt-2 w-3/4 lg:w-full">
        Here are details of my experience as a software engineer, including my
