...
// ListByEducationIDs provides a mock function for the type MockProjectRepository
func (_mock *MockProjectRepository) ListByEducationIDs(ctx context.Context, educationIDs []string) (map[string][]domain.Project, error) {
	ret := _mock.Called(ctx, educationIDs)

	if len(ret) == 0 {
		panic("no return value specified for ListByEducationIDs")
	}

	var r0 map[string][]domain.Project
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, []string) (map[string][]domain.Project, error)); ok {
		return returnFunc(ctx, educationIDs)
	}
	if returnFunc, ok := ret.Get(0).(func(context.Context, []string) map[string][]domain.Project); ok {
		r0 = returnFunc(ctx, educationIDs)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(map[string][]domain.Project)
		}
	}
	if returnFunc, ok := ret.Get(1).(func(context.Context, []string) error); ok {
		r1 = returnFunc(ctx, educationIDs)
	} else {
		r1 = ret.Error(1)
	}
	return r0, r1
...
// MockProjectRepository_ListByEducationIDs_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'ListByEducationIDs'
type MockProjectRepository_ListByEducationIDs_Call struct {
	*mock.Call
}

// ListByEducationIDs is a helper method to define mock.On call
//   - ctx context.Context
//   - educationIDs []string
func (_e *MockProjectRepository_Expecter) ListByEducationIDs(ctx interface{}, educationIDs interface{}) *MockProjectRepository_ListByEducationIDs_Call {
	return &MockProjectRepository_ListByEducationIDs_Call{Call: _e.mock.On("ListByEducationIDs", ctx, educationIDs)}
}

func (_c *MockProjectRepository_ListByEducationIDs_Call) Run(run func(ctx context.Context, educationIDs []string)) *MockProjectRepository_ListByEducationIDs_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *MockProjectRepository_ListByEducationIDs_Call) Return(stringToProjects map[string][]domain.Project, err error) *MockProjectRepository_ListByEducationIDs_Call {
	_c.Call.Return(stringToProjects, err)
	return _c
}

func (_c *MockProjectRepository_ListByEducationIDs_Call) RunAndReturn(run func(ctx context.Context, educationIDs []string) (map[string][]domain.Project, error)) *MockProjectRepository_ListByEducationIDs_Call {
	_c.Call.Return(run)
	return _c
}
